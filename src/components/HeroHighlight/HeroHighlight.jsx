...
export const HeroHighlight = ({ children, className, containerClassName }) => {
  ...
  return (
    <div
      className={twMerge(
        clsx(
          "relative h-60 xs:h-72 sm:h-80 md:h-[30rem] lg:h-[35rem] xl:h-[45rem] flex items-center bg-black justify-center w-full group",
          containerClassName
        )
      )}
    ...
    >
      ...
      />
      <div className={twMerge(clsx("relative z-20", className))}>{children}</div>
    </div>
  );
};
